...
def main():
    ...
    [x3, y3, z3] = sph2cart(r,90.0-26.57, 36.0)
    n3 = Node(x3, y3, z3, 2)
    n3.f_num = 5

    [x4, y4, z4] = sph2cart(r,90.0-26.57, 36.0*3.0)
    n4 = Node(x4, y4, z4, 3)
    n4.f_num = 5

    [x5, y5, z5] = sph2cart(r,90.0-26.57, 36.0*5.0)
    n5 = Node(x5, y5, z5, 4)
    n5.f_num = 5

    [x6, y6, z6] = sph2cart(r,90.0-26.57, 36.0*7.0)
    n6 = Node(x6, y6, z6, 5)
    n6.f_num = 5

    [x7, y7, z7] = sph2cart(r,90.0-26.57, 36.0*9.0)
    n7 = Node(x7, y7, z7, 6)
    n7.f_num = 5

    [x8, y8, z8] = sph2cart(r,(90.0+26.57), 0.0)
    n8 = Node(x8, y8, z8, 7)
    n8.f_num = 5

    [x9, y9, z9] = sph2cart(r,(90.0+26.57), 36.0*2.0)
    n9 = Node(x9, y9, z9, 8)
    n9.f_num = 5

    [x10, y10, z10] = sph2cart(r,(90.0+26.57), 36.0*4.0)
    n10 = Node(x10, y10, z10, 9)
    n10.f_num = 5

    [x11, y11, z11] = sph2cart(r,(90.0+26.57), 36.0*6.0)
    n11 = Node(x11, y11, z11, 10)
    n11.f_num = 5

    [x12, y12, z12] = sph2cart(r,(90.0+26.57), 36.0*8.0)
